...
*/
estafeta("Amilcar",0,"Ferreiros",meio_transporte(1,bicicleta,10,5),317/141,[pedido(cliente("Joaquim",41),1,2021/6/28,"Rua 18","Ferreiros",1,2021/6/20,0),
...
estafeta("Tina",5,"Semelhe",meio_transporte(5,carro,25,100),438/171,[pedido(cliente("Joaquim",41),29,2021/7/16,"Rua 13","Semelhe",78,2021/7/14,1),
                                                                              ...
                                                                              pedido(cliente("Tiago",2),32,2021/10/8,"Rua 19","Semelhe",5,2021/10/7,0),
                                                                              pedido(cliente("Tobias",26),33,2021/8/19,"Rua 3","Semelhe",5,2021/8/19,0),
                                                                              pedido(cliente("Guilherme",16),34,2021/8/12,"Rua 11","Semelhe",29,2021/8/12,1),
                                                                              pedido(cliente("Patrício",43),35,2021/1/25,"Rua 7","Semelhe",5,2021/1/23,0),
                                                                              ...
                                                                              pedido(cliente("Raul",27),39,2021/11/28,"Rua 16","Semelhe",5,2021/11/19,0),
                                                                              pedido(cliente("Rogério",15),40,2021/9/24,"Rua 18","Semelhe",5,2021/9/14,0),
                                                                              pedido(cliente("Paulo",7),41,2021/7/23,"Rua 8","Semelhe",5,2021/7/6,0),
                                                                              pedido(cliente("João",3),42,2021/12/13,"Rua 0","Semelhe",5,2021/12/8,0),
                                                                              pedido(cliente("Simão",1),43,2021/9/7,"Rua 1","Semelhe",5,2021/9/6,0),
                                                                              pedido(cliente("Diogo",24),44,2021/7/31,"Rua 8","Semelhe",99,2021/7/30,1),
                                                                              pedido(cliente("Gil",12),45,2021/10/5,"Rua 15","Semelhe",5,2021/10/1,0)],
                                                                              0).
